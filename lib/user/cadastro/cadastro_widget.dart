...
class _CadastroWidgetState extends State<CadastroWidget> {
  ...
  void initState() {
    ...
    _model.textFieldConfirmeSenhaController ??= TextEditingController();
    _model.textFieldConfirmeSenhaFocusNode ??= FocusNode();
    ...
    return Title(
        ...
        child: GestureDetector(
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              backgroundColor: Colors.white,
              iconTheme: IconThemeData(color: Color(0xFFD70D0D)),
                          ...
                          children: [
                            Expanded(
                              child: Padding(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.textFieldConfirmeSenhaController,
                                  focusNode:
                                      _model.textFieldConfirmeSenhaFocusNode,
                                  obscureText:
                                      !_model.textFieldConfirmeSenhaVisibility,
                                  decoration: InputDecoration(
                                    ...
                                    suffixIcon: InkWell(
                                      onTap: () => setState(
                                        () => _model
                                                .textFieldConfirmeSenhaVisibility =
                                            !_model
                                                .textFieldConfirmeSenhaVisibility,
                                      ),
                                      focusNode: FocusNode(skipTraversal: true),
