...
import 'sabores_model.dart';
export 'sabores_model.dart';

class SaboresWidget extends StatefulWidget {
  const SaboresWidget({
    Key? key,
  ...
  @override
  _SaboresWidgetState createState() => _SaboresWidgetState();
}

class _SaboresWidgetState extends State<SaboresWidget> {
  late SaboresModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SaboresModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<ProdutoRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final saboresProdutoRecord = snapshot.data!;
        return Title(
            title: 'Sabores',
                                ...
                                Padding(
                                  ...
                                  child: StreamBuilder<NsaborRecord>(
                                    stream: NsaborRecord.getDocument(
                                        saboresProdutoRecord.numeroSabor!),
                                    builder: (context, snapshot) {
                                      // Customize what your widget looks like when it's loading.
                                      if (!snapshot.hasData) {
                                        return Center(
