              ...
              child: Column(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      if (functions
                          .existeItem(FFAppState().produtosVendaLOCAL.toList()))
                        Container(
                          ...
                          children: List.generate(produtosUsuario.length,
                            ...
                            return StreamBuilder<ProdutoVendaRecord>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                final rowGeralProdutoVendaRecord =
                                    snapshot.data!;
                                return Row(
                                  mainAxisSize: MainAxisSize.max,
                                  mainAxisAlignment: MainAxisAlignment.center,
