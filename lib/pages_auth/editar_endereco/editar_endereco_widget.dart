...
import 'editar_endereco_model.dart';
export 'editar_endereco_model.dart';

class EditarEnderecoWidget extends StatefulWidget {
  const EditarEnderecoWidget({
    Key? key,
  ...
  @override
  _EditarEnderecoWidgetState createState() => _EditarEnderecoWidgetState();
}

class _EditarEnderecoWidgetState extends State<EditarEnderecoWidget>
    with TickerProviderStateMixin {
  late EditarEnderecoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditarEnderecoModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<EnderecoRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final editarEnderecoEnderecoRecord = snapshot.data!;
        return Title(
            title: 'editarEndereco',
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.textRuaController ??=
                                                  TextEditingController(
                                            text: editarEnderecoEnderecoRecord
                                                .rua,
                                          ),
