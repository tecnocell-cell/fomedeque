...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    userStream = deliveryClienteFirebaseUserStream()
...
class _NavBarPageState extends State<NavBarPage> {
  String _currentPageName = 'Restaurantes';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: GNav(
        ...
        tabBorderRadius: 8.0,
        tabMargin: EdgeInsetsDirectional.fromSTEB(25.0, 3.0, 3.0, 3.0),
